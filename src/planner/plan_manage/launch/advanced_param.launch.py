...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/lidar_max_range': 6.0},
            {'grid_map/use_lidar_buffer': True},
            {'grid_map/lidar_sync_tolerance': 0.1},
            {'grid_map/lidar_fallback_timeout': 0.2},
            {'grid_map/depth_hit_scale': 1.0},
            {'grid_map/depth_miss_scale': 1.0},
            {'grid_map/fusion_conflict_scale': 0.9},
            {'grid_map/publish_conflict_cloud': True},
            {'grid_map/enable_fusion_stats': True},
            {'grid_map/fusion_stats_path': "/tmp/grid_map_fusion_stats.csv"},
            {'grid_map/lidar_hit_scale': 0.4},
            {'grid_map/lidar_miss_scale': 0.4},
