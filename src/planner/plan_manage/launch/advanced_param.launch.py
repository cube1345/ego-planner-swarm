...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/lidar_sync_tolerance': 0.08},
            {'grid_map/lidar_sync_tolerance_relaxed': 0.16},
            {'grid_map/lidar_fallback_timeout': 0.15},
            {'grid_map/odom_fallback_timeout': 0.15},
            {'grid_map/depth_hit_scale': 1.0},
            {'grid_map/depth_miss_scale': 1.0},
            {'grid_map/fusion_conflict_scale': 0.6},
            {'grid_map/publish_conflict_cloud': False},
            {'grid_map/enable_fusion_stats': False},
